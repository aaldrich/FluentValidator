...
namespace Validation.Mapping.ValidationBuilders.Dates
{
    public partial class DateValidationBuilder<T>
    {
        public CompositeValidationBuilder<T, IDateTimeEntryValidationBuilder<T>> greater_than(DateTime value)
        {
            ...
            return new CompositeValidationBuilder<T, IDateTimeEntryValidationBuilder<T>>(new DateTimeValidationBuilder<T>(expression,validators));
        }
        ...
        public BetweenValidationBuilder<T, IDateTimeEntryValidationBuilder<T>, DateTime> between(DateTime lower, DateTime upper)
        {
            ...
            return new BetweenValidationBuilder<T, IDateTimeEntryValidationBuilder<T>, DateTime>
                (expression, inclusive_validator, new DateTimeValidationBuilder<T>(expression,validators), lower, upper);
        }
    }
}