...
namespace Validation.Mapping.ValidationBuilders.Numeric.Decimals
{
    public interface IDecimalSpecificationValidationBuilder<T> where T : class
    {
        ...
        IFailureEntryValidationBuilder<T, IDecimalEntryValidationBuilder<T>> greater_than_or_equal_to(decimal value);
        ...
        IFailureEntryValidationBuilder<T, IDecimalEntryValidationBuilder<T>> less_than_or_equal_to(decimal value);
