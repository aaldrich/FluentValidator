...
{
    public class GreaterThanEqualToValidator<T,TProperty>: ValidatorBase<T>, IValidator<T>
        ...
        where T : class 
    {
        ...
        public GreaterThanEqualToValidator(Expression<Func<T,TProperty>> expression, TProperty comparison_value)
        {
            ...
            this.failure_message_strategy = new ExpressionFailureMessageStrategy(
                expression.Body as MemberExpression,"greater than or equal to", comparison_value.ToString());
        }
